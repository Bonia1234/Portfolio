...
// Service object to hold new service information
const service = ref({
    name: null,
    description: null,
    status: "Active",
...
async function handleSubmitForm() {
    ...
    try {
        ...
        router.push('/findservice'); // Navigate to find service page
    } catch (error) {
        toast.error('Error creating new service:', error); // Display error notification
    }
}
</script>
